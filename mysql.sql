...
insert into `person` (  `userName`, `password`, `nickName`, `userType`) values( 'buyer',
'37254660e226ea65ce6f1efd54233424','buyer','0');

insert into `person` (  `userName`, `password`, `nickName`, `userType`) values( 'seller',
'981c57a5cfb0f868e064904b8745766f','seller','1');
